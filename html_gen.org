...
<<structures>>
#+end_src
Once again, our core specification for the parser is to extract a set of key value pairs. Our syntax, just to keep it simple
...
#+begin_src rust :tangle src/parser.rs :noweb yes :comments org
pub fn parse_source_string(source: &str) -> Result<(String, HashMap<String,String>),ParseError> {
<<source parsing code>>
}
#+end_src
